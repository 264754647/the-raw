    ...
    <html>
      <head>
        ...
        <style>
          ...
          .header { background: #000; color: #fff; padding: 30px; text-align: center; margin-bottom: 30px; }
          ...
          .section h2 { font-size: 14px; font-weight: 400; letter-spacing: 0.5px; text-transform: uppercase; border-bottom: 2px solid #f0f0f0; padding-bottom: 10px; margin-bottom: 15px; }
          .section p { margin: 8px 0; font-size: 13px; }
          table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
          th { text-align: left; padding: 12px; background: #f5f5f5; font-weight: 500; font-size: 12px; text-transform: uppercase; }
          .footer { background: #f9f9f9; padding: 20px; text-align: center; font-size: 12px; color: #999; }
          .status { background: #f0f0f0; padding: 15px; border-left: 4px solid #4caf50; margin-bottom: 20px; }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>&copy; ${new Date().getFullYear()} Clothing Shop. All rights reserved.</p>
          </div>
        </div>
      </body>
    </html>
